...
function renderHero(state, data) {
    ...
    // Fallback if state is null, empty string, or unknown
    const validStates = ['outside_window', 'pending', 'review', 'verified', 'reject'];
    if (!state || !validStates.includes(state.toString().trim())) {
        state = 'pending';
    }
